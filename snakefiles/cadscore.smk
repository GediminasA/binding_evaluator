rule run_cadscore_eval:
    input:
        mut = work_dir + "/mutants_structure_generation/TEMPLATES/faspr_models/{pdb}={chain}={mutations}.pdb",
        wt = work_dir + "/mutants_structure_generation/TEMPLATES/faspr_models/{pdb}={chain}=nan.pdb",
